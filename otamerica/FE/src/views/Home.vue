    ...
    <v-container class="text-justify">
      ...
      <v-row>
        <v-col cols="12" md="2" sm="2">
          <v-img
            src="@/assets/images/certificates/otamerica_ar_spanish_2023_certification_badge.png"
          ></v-img>
        </v-col>
        <v-col cols="12" md="2" sm="2">
          <v-img
            src="@/assets/images/certificates/otamerica_br_portuguese_2023_certification_badge.png"
          ></v-img>
        </v-col>
        <v-col cols="12" md="2" sm="2">
          <v-img
            src="@/assets/images/certificates/otamerica_co_spanish_2023_certification_badge.png"
          ></v-img>
        </v-col>
        <v-col cols="12" md="2" sm="2">
          <v-img
            src="@/assets/images/certificates/otamerica_mx_english_2023_certification_badge.png"
          ></v-img>
        </v-col>
        <v-col cols="12" md="2" sm="2">
          <v-img
            src="@/assets/images/certificates/otamerica_pa_spanish_2023_certification_badge.png"
          ></v-img>
        </v-col>
        <v-col cols="12" md="2" sm="2">
          <v-img
            src="@/assets/images/certificates/otamerica_pe_spanish_2023_certification_badge.png"
          ></v-img>
        </v-col>
      </v-row>
